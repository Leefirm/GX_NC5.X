...
public class InitSjfksjDataTest {
	...
	public static void initFinishedData() throws BusinessException {
		...
		List<SjfksjHVOC> listMill = (List<SjfksjHVOC>) NCLocator
				...
				.lookup(IUAPQueryBS.class)
				.executeQuery(
						"select  qianshouriqi qsrq, YiJiaoSheJiRiQi  yjsjrq,YuSuanGongChengKuan ysgck, BuJiaoKanSheFei bjksf, baozhuangbianhao RESERVE1,GCMC pk_jobbasfil, SheJiJingBanRenYuan jbry, SheJiRenYuan sjry, SheJiTuHao sjth, FaDanRiQi fdrq,QianShouRiQi qsrq,BuJiaoKanSheFei bjksf,BeiZhu remark from bz  " //勘察派工人员=勘察人员，勘察派工日期=勘察日期
						+ sqlwhereMill
