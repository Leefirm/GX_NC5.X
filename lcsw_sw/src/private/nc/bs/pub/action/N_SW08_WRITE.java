...
//values ('WRITE', 'N_SW08_WRITE', 0, 'N', 'SW08', '140821112930225FEII6', NULL, '0001', '2014-08-21 11:29:30')
//go
...
//values ('保存', NULL, NULL, 'WRITE', 'N', 'Y', 0, 'Y', '140821112930325GIN85', 'SW08', NULL, '2014-08-21 11:29:30')
//go
...
/**
 * 备注：单据:<b><code>SW08</code></b> 的保存 <tt>WRITE</tt> 动态执行类。
 * 
 * @since 创建日期：2014-08-21 11:29:30
 * @version UAP 5.x 
 * @author Administrator
 * @author NC Plugin
 */
public class N_SW08_WRITE extends AbstractCompiler2 {
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			if(ysxxfkBVO != null) {
				for (YsfksjBVO ysfksjBVO : ysxxfkBVO) {
