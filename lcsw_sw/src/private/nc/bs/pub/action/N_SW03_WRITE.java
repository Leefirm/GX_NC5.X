...
//values ('保存', NULL, NULL, 'WRITE', 'N', 'Y', 0, 'Y', '14080717310253261I54', 'SW03', NULL, '2014-08-07 17:31:02')
//go
...
/**
 * 备注：单据:<b><code>SW03</code></b> 的保存 <tt>WRITE</tt> 动态执行类。
 * 
...
//			//panqh校验
//			/*
//			 * 日期逻辑关系：非三优先的，勘察设计费的[销账日期]<=[勘察派工日期]<=[当前日期]；
...
//				throw new BusinessException("当前日期:" + dmakedate + "必须大于等于勘察派工日期:" + kcpgrq);
//			}
//			if("Y".equals(issy) || "y".equals(issy)) {
//				//三优先的情况
//			}
//			else {//非三优:勘察设计费的[销账日期]<=[勘察派工日期]<=[当前日期]；
...
//					throw new BusinessException("非三优先勘察派工日期:" + kcpgrq + "必须大于等于销账日期:" + xzrq);
//				}
//				
//			}
