...
public class CXXiaoZhangDialog extends UIDialog implements ValueChangedListener, ActionListener {
	...
	public CXXiaoZhangDialog() {
		initialize();
	}

	public CXXiaoZhangDialog(BillCardPanel sw10panel) {
		// super(parent, title);
