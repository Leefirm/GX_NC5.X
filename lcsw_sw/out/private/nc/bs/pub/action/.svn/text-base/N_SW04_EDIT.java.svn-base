...
//values ('EDIT', 'N_SW04_EDIT', 0, 'N', 'SW04', '140813163336446SBN75', NULL, '0001', '2014-08-13 16:33:36')
//go
...
//values ('修改', NULL, NULL, 'EDIT', 'N', 'Y', 0, 'Y', '140813163336546FTEVS', 'SW04', NULL, '2014-08-13 16:33:36')
//go
...
/**
 * 备注：单据:<b><code>SW04</code></b> 的修改 <tt>EDIT</tt> 动态执行类。
 * 
 * @since 创建日期：2014-08-13 16:33:36
 * @version UAP5.x 
 * @author 平台脚本生成 编辑脚本
 */
public class N_SW04_EDIT extends AbstractCompiler2 {
