...
//values ('UNAPPROVE', 'N_SW10_UNAPPROVE', 0, 'N', 'SW10', '140812163327511MV5X0',NULL, '0001', '2014-08-12 16:33:27')
//go
...
//values ('弃审', NULL, NULL, 'UNAPPROVE', 'N', 'Y', 0, 'Y', '1408121633276117505G', 'SW10', NULL, '2014-08-12 16:33:27')
//go
...
/**
 * 备注：单据:<b><code>SW10</code></b> 的弃审  <tt>UNAPPROVE</tt> 动态执行类。
 * 
 ...
 * @author NC Plugin
 */
public class N_SW10_UNAPPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	/**
	 * N_SW10_UNAPPROVE 构造子注解。
	 */
	public N_SW10_UNAPPROVE() {
		super();
	}
