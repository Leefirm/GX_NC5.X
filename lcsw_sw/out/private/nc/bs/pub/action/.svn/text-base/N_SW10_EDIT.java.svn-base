...
//values ('EDIT', 'N_SW10_EDIT', 0, 'N', 'SW10', '14081216332817680ZFH', NULL, '0001', '2014-08-12 16:33:28')
//go
...
//values ('修改', NULL, NULL, 'EDIT', 'N', 'Y', 0, 'Y', '1408121633282765VQSN', 'SW10', NULL, '2014-08-12 16:33:28')
//go
...
/**
 * 备注：单据:<b><code>SW10</code></b> 的修改 <tt>EDIT</tt> 动态执行类。
 * 
 * @since 创建日期：2014-08-12 16:33:28
 * @version UAP5.x 
 * @author 平台脚本生成 编辑脚本
 */
public class N_SW10_EDIT extends AbstractCompiler2 {
