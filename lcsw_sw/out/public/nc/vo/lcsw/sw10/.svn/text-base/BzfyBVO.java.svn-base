...
public class BzfyBVO extends SuperVO {
	...
	public static final String PK_BZFY_B = "pk_bzfy_b";
	...
	public static final String SFRY = "sfry";
	...
	public static final String XZRQ = "xzrq";
	public static final String RESERVE19 = "reserve19";
	public static final String TFRQ = "tfrq";
	 ...
	 * 
	 */ 
	public void setXzbz(UFBoolean newXzbz){
		 this.xzbz = newXzbz;
	}
	/** 
	 * 
	 ...
	 * 
	 */ 
	public void setPk_bzfy_b(String newPk_bzfy_b){
		 this.pk_bzfy_b = newPk_bzfy_b;
	}
	/** 
	 * 
	 * 属性<预留字段5>的Getter方法
	 ...
	 * 
	 */ 
	public void setSfry(String newSfry){
		 this.sfry = newSfry;
	}
	/** 
	 * 
	 ...
	 * 
	 */ 
	public void setXzrq(UFDate newXzrq){
		 this.xzrq = newXzrq;
	}
	 ...
	 * 
	 */ 
	public void setTfrq(UFDate newTfrq){
		 this.tfrq = newTfrq;
	}
